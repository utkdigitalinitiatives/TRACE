...
drush -r "$DRUPAL_HOME" user-information privUser 2>&1 | grep '\[error\]' && drush -r "$DRUPAL_HOME" user-create privUser --mail="vagrant@localhost.com" --password="privUser" && echo "Created privUser user" || echo "The privUser already exists"
