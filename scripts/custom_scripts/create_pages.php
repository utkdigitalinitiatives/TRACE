...
<ul>
    <li>
        <a
            href="http://libguides.utk.edu/trace/authors"
            rel="nofollow"
            title="Follow link"
        >
            Submission Guide for Individual Authors/Researchers
        </a>
    </li>
    <li>
        <a
            href="http://libguides.utk.edu/trace/coordinators"
            rel="nofollow"
            title="Follow link"
        >
            Submission Guide for Collection Coordinators
        </a>
    </li>
    <li>
        <a
            href="http://libguides.utk.edu/trace/graduate"
            rel="nofollow"
            title="Follow link"
        >
            Submission Guide for Graduate Students (Theses and Dissertations)
        </a>
    </li>
</ul>
