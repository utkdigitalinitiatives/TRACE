 ...
 *
fedora_datastream_info_PDF_FEDORA_URI_ms
...
//OBJECT PAGE OVERRIDES
// This is a template correction to format the object page to comply with Google Scholar Inclusion Rules.
// The if statement:  if (strpos(current_path(), 'utk.ir.td') !== false)
//   is only because we don't have anthing outside etds for now.  Needs to be changed in future.
...
//chd code insert to change display from (year)title to Author mods_utk_etd_author_name
  $prefix  = '<div class="csl-bib-body"><div style=" text-indent: -25px; padding-left: 25px;"><div class="csl-entry">Author TEST:  ';
  $content = mods_utk_edt_author_name;
  $suffix  = '</div></div></div>';
